public class Laptop extends Komputer implements IMouse, IKeyboard, IPrinter {
    ...
    Laptop(String nama, String processor, String ram, String penyimpanan) {
    ...
    @Override
    void hidupkan_os() {
        System.out.println("| Menghidupkan Laptop \t\t\t\t\t\t|");
    ...
    public void klik_kanan() {
        System.out.println("| Klik kanan pada Mouse Laptop \t\t\t\t\t|");
        
    }

    @Override
    public void klik_kiri() {
        System.out.println("| Klik kiri pada Mouse Laptop \t\t\t\t\t|");
        
    }

    @Override
    public void tekan_enter() {
        System.out.println("| Tekan Enter pada Keyboard Laptop \t\t\t\t|");
        
    }

    @Override
    public void cetak_data() {
        System.out.println("| Cetak data melalui Printer yang terhubung dengan Laptop \t|");
